This list [accepts and encourages pull requests](https://github.com/kakoni/awesome-health).

# Contribution Guidelines

- **To add to the list:** Submit a pull request to [README.md](https://github.com/kakoni/awesome-health/blob/master/README.md), optionally add comment if you wish to elaborate/explain.
- **To edit an item:** Submit a pull request to [README.md](https://github.com/kakoni/awesome-health/blob/master/README.md), add comment explaining the reasoning behind the change.
